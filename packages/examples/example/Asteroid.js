...
testbed('Asteroid', function (testbed) {
    ...
    function setupShip() {
        ...
        shipBody.createFixture(new PolygonShape([
            new Vec2(-0.15, -0.15),
            new Vec2(0, -0.1),
            new Vec2(0.15, -0.15),
            new Vec2(0, 0.2)
    ...
    function tick(dt) {
        ...
        if (shipBody) {
            ...
            if (testbed.activeKeys.fire && globalTime > allowFireTime) {
                ...
                bulletBody.createFixture(new CircleShape(0, 0, 0.05), {
    ...
    function makeAsteroidBody(x, y, vx, vy, va, level) {
        const asteroidBody = world.createBody({
            type: Body.KINEMATIC,
            // mass : 10,
        ...
        asteroidBody.createFixture(new PolygonShape(path), {
