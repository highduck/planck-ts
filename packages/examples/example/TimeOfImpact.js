...
testbed('TimeOfImpact', function (testbed) {
    ...
    const shapeA = new BoxShape(25.0, 5.0);
    const sweepA = new Sweep();
    sweepA.c0.set(0, 0);
    sweepA.a0 = 0.1;
    sweepA.c.copyFrom(sweepA.c0);
    sweepA.a = sweepA.a0;
    sweepA.localCenter.setZero();

    const shapeB = new BoxShape(2.5, 2.5);
    ...
    testbed.step = function () {
        ...
        for (let t = 0.1; t < 1.0; t += 0.1) {
            ...
            vertices = shapeB.m_vertices.map((v) => Transform.mulVec2(transformB, v));
        ...
        vertices = shapeA.m_vertices.map((v) => Transform.mulVec2(transformA, v));
